...
class Electrician(Visitor): #Inherits from the árent class, Visitor
...
#Let the house accept the Hvac specialist and work on the house by invokin the visit() method
home.accept(hv)

#Let the house accet the electrician and work on the house by invoking the visit() method
home.accept(e)
